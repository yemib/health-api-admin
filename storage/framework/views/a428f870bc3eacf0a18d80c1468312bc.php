          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title"> <?php if(isset($title)): ?>  <?php echo e($title); ?> <?php else: ?>  Blog <?php endif; ?></h3>
              </div>
              <div class="panel-body">
                <div class="row">
                      <div class="col-md-12">
                         ...
                         <a  href="/newsletters/create"   class="btn btn-primary"  >  Add <?php if(isset($title)): ?>  <?php echo e($title); ?> <?php else: ?>  Blog <?php endif; ?>  </a>
