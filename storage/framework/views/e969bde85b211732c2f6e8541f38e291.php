            ...
            <div class="row">
                ...
                <div class="col-md-3  form_container">
                    <div class="list-group">
                        ...
                        <a href="/pages" class="list-group-item"><span class="glyphicon glyphicon-list-alt"
                                aria-hidden="true"></span> Pages </a>




                        <a href="/newsletters" class="list-group-item"><span class="glyphicon glyphicon-pencil"
                                aria-hidden="true"></span> Blog </a>
                        <a href="/testimony" class="list-group-item"><span class="glyphicon glyphicon-pencil"
                                aria-hidden="true"></span> Testimonies </a>



                        <a href="/managements" class="list-group-item"><span class="glyphicon glyphicon-pencil"
                                aria-hidden="true"></span> Management </a>



                        <a href="/gallery" class="list-group-item"><span class="glyphicon glyphicon-pencil"
                                aria-hidden="true"></span> Gallery </a>
                        ...
                        <a href="/contact" class="list-group-item"><span class="glyphicon glyphicon-phone"
                                aria-hidden="true"></span> Contact Info </a>




                        <a href="/slidder" class="list-group-item"><span class="glyphicon glyphicon-phone"
                                aria-hidden="true"></span> Slidder (Banners) </a>



                        <a href="/logo" class="list-group-item"><span class="glyphicon glyphicon-phone"
                                aria-hidden="true"></span> Logo </a>




                        <a href="/users" class="list-group-item"><span class="glyphicon glyphicon-user"
