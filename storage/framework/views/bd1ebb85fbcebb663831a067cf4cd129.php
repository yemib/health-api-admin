 ...
 <div class="col-md-9">
   ...
   <div class="panel panel-default">
     <div class="panel-heading main-color-bg">
       <h3 class="panel-title">Add Testimony</h3>
     </div>
     <div class="panel-body">

      <a   class="btn btn-primary" href="/testimony"> Testimony  List     </a>



       <form    method="post" action="<?php if(isset($service)): ?> /testimony/<?php echo e($service->id); ?>  <?php else: ?> /testimony <?php endif; ?>"  enctype="multipart/form-data"   >
...
<?php echo $__env->make('admin_folder/index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\website\health\health-api-admin\resources\views/admin_folder/add_testimony.blade.php ENDPATH**/ ?>